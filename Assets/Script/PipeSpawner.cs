...
public class PipeSpawner : MonoBehaviour
{
    ...
    void SpawnPipe()
    {
        ...
        //membuat random ukuran pipa
        randomPipe = Random.Range(1, 5);
        newPipeUp.transform.localScale = new Vector3(randomPipe * 2, randomPipe * 2) ;
        newPipeDown.transform.localScale = new Vector3(randomPipe * 2, randomPipe * 2);
    }
    ...
    IEnumerator IeSpawn()
    {
        while (true)
        {
            ...
            yield return new WaitForSeconds((spawnInterval*5)+(spawnInterval*(5-randomPipe)));
        }
    }
}